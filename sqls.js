...
sqls.copy_zi_ins = `INSERT IGNORE INTO fayu.fayu_hi(bh_id, bh_has_tr, bh_hex, bh_sm, bh_tr, bh_pin, bh_trans) SELECT bh_id, bh_has_tr, bh_hex, bh_sm, bh_tr, bh_pin, bh_trans FROM mova.bkrs_hi WHERE bh_id =?`;

sqls.copy_ci_inst = 'INSERT IGNORE INTO fayu.fayu_word(bw_id, bw_bh_id, bw_has_tr, bw_length, bw_sm, bw_tr, bw_pin, bw_trans) SELECT bw_id, bw_bh_id, bw_has_tr, bw_length, bw_sm, bw_tr, bw_pin, bw_trans FROM mova.bkrs_word WHERE bw_id=?';
